...
document.addEventListener('DOMContentLoaded', () => {
    ...
    dom.qbankBtn.addEventListener('click', () => checkPermission('MCQBank') && (ui.showScreen(dom.qbankContainer), appState.navigationHistory.push(() => ui.showScreen(dom.qbankContainer))));
